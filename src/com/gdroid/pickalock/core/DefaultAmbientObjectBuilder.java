...
public class DefaultAmbientObjectBuilder extends AmbientObject.MyBuilder {
	 ...
	 * @param renderer
	 */
	public DefaultAmbientObjectBuilder(GameRenderer renderer) {
		this.renderer = renderer;
	}

	@Override
	public void attachPositioning(AmbientObject t) {
	...
	@Override
	public void attachRender(AmbientObject t) {
